...
export function rebaseSystemPrompt(nowStamp) {
  return [
    ...
    "KHÔNG mặc định rebase: nhánh diverge nhiều / dùng chung (nhiều người cùng push) thì MERGE develop vào nhánh",
    ...
    "Base mặc định là `develop` cho MỌI repo (xem config/github.json). Nhánh nào base khác thì user sẽ nêu rõ —",
    "vẫn XÁC MINH bằng `git merge-base`/upstream trước khi thao tác; không chắc base thì HỎI, KHÔNG đoán.",
