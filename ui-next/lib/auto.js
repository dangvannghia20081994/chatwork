...
export function assembleSystemPrompt() {
  const parts = [
    ...
    [
      ...
      "1) read ticket, 2) pick repo + sync base feature/mvp2, 3) create branch",
      ...
      "9) create the PR (base feature/mvp2, title `[<phase>] <SCREEN-CODE> | REZIL-XXXX - <summary>`).",
      ...
      "10) comment the Jira ticket with the PR link + scope. Format the PR link as a MARKDOWN",
      "    link `[<url>](<url>)` (NOT a bare URL) so it renders clickable in Jira via MCP→ADF.",
